...
<html lang="en">
    ...
    <body>
        <h3>Excluir Usuário <span class="id_user"></span>?</h3>
        ...
        <div class="form_container">
            ...
            <div>
                ...
                <input type="text" id="phone" name="phone" maxlength="12" readonly>
            </div>
            <div>
            ...
            <div>
                <button type="button" id="excludeUser" onclick="exclude(<?php echo $id; ?>)">Excluir</button>
            </div>
        </div>
        <h3>Retorno da API:</h3>
        <pre id="api_return" style="display: none;">

        </pre>
        <pre id="api_return_delete">
